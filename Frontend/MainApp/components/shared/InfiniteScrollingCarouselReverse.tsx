...
export default function InfiniteScrollingCarouselReverse({
  children,
  carouselData,
}: {
  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      >
        {carouselData && carouselData.length > 0 ? (
          <div
            className="flex"
            style={{
              animation: `infiniteScrollLeftToRight ${scrollDuration}s linear infinite`,
      ...
      {/* CSS Animation */}
      <style jsx>{`
        @keyframes infiniteScrollLeftToRight {
          0% {
