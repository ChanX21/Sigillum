...
const UnlistedNfts = () => {
  ...
  const filterNft = (filterType: string) => {
    ...
    const filtered =
      filterType === "all"
        ? source
        : source.filter((nft) => nft.status === filterType);
  ...
  return (
    <div>
      <Header />
      <div
        className={`md:px-10 px-1 md:mt-32 min-h-screen pb-5 ${
        ...
        {connected ? (
          <>
            {isLoading ? (
              ...
              <Tabs
                defaultValue="all"
                className="w-full md:mt-0 mt-20 px-4 md:px-0"
                onValueChange={(value) => filterNft(value)}
              >
                <div className="flex items-center justify-between">
                  ...
                  <TabsList className="cursor-pointer">
                    ...
                    <TabsTrigger value="soft-listed" className="cursor-pointer">
                      Unlisted
                    </TabsTrigger>
                    <TabsTrigger value="listed" className="cursor-pointer">
                      Listed
                    </TabsTrigger>
                  </TabsList>
                </div>
                  ...
                  {filteredNfts && filteredNfts.length != 0 ? (
                    ...
                    <div className="flex min-h-[60vh] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center">
                      ...
                      <h2 className="mt-6 text-2xl font-semibold">
                        No Secured Image Found
                      </h2>
                      <p className="mt-2 max-w-md text-muted-foreground">
                        There are no secured images available in this
                        collection. Secure your image or explore other
                        collections.
                      </p>
                ...
                <TabsContent value="listed" className="mt-6">
                  {filteredNfts && filteredNfts.length != 0 ? (
                    ...
                    <div className="flex min-h-[60vh] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center">
                      ...
                      <p className="mt-2 max-w-md text-muted-foreground">
                        You haven't secured any image yet. Start securing your
